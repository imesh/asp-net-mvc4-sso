...
namespace Mvc4SingleSignOnSAML2.Controllers
{
    public class TokenApiClient
    {
        public string GetAccessToken()
        {
            ...
            //string content = "grant_type=urn:ietf:params:oauth:grant-type:saml2-bearer&assertion=" +
            //    HttpUtility.UrlEncode(Convert.ToBase64String(Encoding.UTF8.GetBytes(samlAssertion)))
            //    + "&scope=PRODUCTION";
